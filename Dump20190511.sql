...
INSERT INTO `cliente` VALUES (10666555,'Luis','Damiano','(351)123-4567','luis.damiano@net.com',6,'maestro Lopez s/n'),(12345678,'Perez','Juan','(351)123-4567','juan.perez@net.com',5,'Colon 123');
...
INSERT INTO `cuenta_corriente` VALUES (1,0,1000),(2,0,1000),(3,0,1000),(4,0,1000),(5,0,1000),(6,0,100),(7,0,100);
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Usuarios Ingreso al Sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-11 22:24:23
